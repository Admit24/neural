...
from neural.models.segmentation.espnet import espnet_c
...
train_dataset = Cityscapes(dataset_dir, split='trainextra', transforms=train_tfms)
...
if local_rank == 0:
    checkpointer = ModelCheckpoint(
        dirname=os.path.join('checkpoints', 'espnet_c'),
        filename_prefix='espnet_c',
        score_name='miou',
